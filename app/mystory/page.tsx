export default function MyStory() {
  return (
    <div>
      ...
      <p className="mt-4 mx-4 px-2 bg-red-300 text-lg text-white">
      My Why "Constantly searching for enlightenment through deep focus coding and learning. Constantly attempting to get into and remain in the bliss of the flow state, where time and space appear not to exist. Enmeshed in the code, in the system, in the web, building for the future.
"
      </p>
    </div>
  )
