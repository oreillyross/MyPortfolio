      ...
      <section>
        ...
        <section>
          ...
          <ul>
            ...
            <li>Brainy Notes</li>
            <p>
              This project is a spin-off from the much over done Blog post, and
              tod list apps that everyone does when demostrating a certain piece
              of technology, language, framework etc. I decided to create this
              project because it also solves a personal pain point for me, as I
              am constantly saving snippets of code, good practices, config
              settings etc and as of yet havent found a reasonable place to
              sotre this data for easy retrieval. So I created brainy notes. It
              is built using create react app and typescript, uses supabase as
              the BAAS for data storage, tailwindCSS for styling, react router,
              and react query for caching. The app is intended to be re(built)
              multiple times over as I learn other technoligies. Linraries which
              I really want to try out next include: 1. tRPC, 2. Prisma and
              Apollo 3. NX monorepo
            </p>
